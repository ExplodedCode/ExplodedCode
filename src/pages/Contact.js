...
const Contact = () => {
    useDocTitle('Exploded Code - Send us a message')
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    ...
                    <div
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <p className="text-gray-400">info@explodedcode.com</p>
                                    </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <Link to="/instagram" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1" aria-label="Facebook">
                                ...
                                <Link to="/linkedin" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1" aria-label="Facebook">
